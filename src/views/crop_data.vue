  ...
  <div>
    ...
    <div class="container">
      ...
      <el-table
        ...
        <el-table-column prop="id" label="数据ID" width="70" align="center"></el-table-column>
        <el-table-column prop="cropType" label="作物类型"></el-table-column>
        <el-table-column label="采样经度">
          <template #default="scope">{{ scope.row.longitude }}</template>
        </el-table-column>
        <el-table-column label="采样纬度">
          <template #default="scope">{{ scope.row.latitude }}</template>
        </el-table-column>
        <el-table-column prop="date" label="采集时间"></el-table-column>
        <el-table-column label="实测数据" width="180" align="center">
          <template #default="scope">{{ JSON.stringify(scope.row.data) }}</template>
        </el-table-column>
        <el-table-column prop="user" label="所属用户" align="center"></el-table-column>
